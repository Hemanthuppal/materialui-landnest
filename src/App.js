...
import Category from "./Components/Admin/AdminUploadedProperties/Addcategory";
    ...
    <AuthProvider>
      ...
      <Route 
        ...
        /> */}
          ...
          <Route
            path="/construction-get-started"
            element={<ConstructionGetStarted />}
          />
          <Route
            path="/explore-construction-resources"
            element={<ExploreConstructionResources />}
          />
          <Route path="/two-d-plane-interior" element={<TwodPlansInterior />} />
          <Route
            path="/three-d-plane-interior"
            element={<ThreedPlansInterior />}
          />
          ...
          <Route
            path="/hot-property-description"
            element={<HotProperties_description />}
          />
          <Route
          ...
          <Route
            path="/lease_description/:id"
            element={<Lease_discription />}
          />
          ...
          <Route
            path="/adminuploadproperties"
            element={<AdminUploadProperties />}
          />
          <Route path="/admin-2dplans" element={<AdminTwoDPlans />} />
          <Route path="/admin-3dplans" element={<AdminThreeDPlans />} />
          <Route path="/admin-packages" element={<AdminPackages />} />
          <Route
            path="/admin-explore-constructions"
            element={<AdminExploresConstructions />}
          />
          ...
          <Route
            ...
            element={<AdminUploadPropertiesForm />}
          />
