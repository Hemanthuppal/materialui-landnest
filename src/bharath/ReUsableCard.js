...
import { Favorite, FavoriteBorder, Share, Close, ThumbUpAlt, ThumbUpAltOutlined, Call, LocationOn, ChevronLeft, ChevronRight } from '@mui/icons-material';
...
const ReUsableCard = ({ property, onCardClick, isSaved, toggleSave, likedCards, toggleLike, onClose }) => {
  ...
  <IconButton
    ...
    onClick={(e) => {
      e.stopPropagation();
      const rawPhone = property.admin_mobile || property.mobile_no;
      ...
      <CardContent sx={{ px: 2, py: 0.5, pb: '7px !important' }}>
        ...
        <Box sx={{ 
          ...
          <Button
            ...
            onClick={(e) => {
              e.stopPropagation();
              const phone = property.admin_mobile || property.mobile_no;
