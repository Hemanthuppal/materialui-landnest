...
import './../Rajesh/CustomBottomNav.css';

const navItems = [
  { key: 'home', icon: <HomeIcon />, route: '/dashboard', label: 'Home' },
  { key: 'list', icon: <FormatListBulletedIcon />, route: '/hot-property-details', label: 'List' },
  { key: 'saves', icon: <FavoriteBorderIcon />, route: '/hot-property-saves', label: 'Saves' },
